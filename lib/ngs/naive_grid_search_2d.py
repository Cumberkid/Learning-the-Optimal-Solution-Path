import numpy as np
import torch
from lib.ngs.solver import train_bfgs, test
...
def GD_on_a_grid(fix_lam, running_lam, lam_max, epochs, loss_fn, model, test_model, optimizer, trainDataLoader,
    ...
    for t in range(epochs):
        ...
        itr, weight, intercept = train_bfgs(itr, weight, intercept, trainDataLoader, model, loss_fn, 
    ...
    return itr, grad_calls, error, weight, intercept
...
def naive_grid_search(fix_lam, lam_min, lam_max, num_grid, epochs, loss_fn, trainDataLoader,
    ...
    for running_lam in lambdas:
        ...
        evals, grad_calls, grid_error, weight, intercept = GD_on_a_grid(fix_lam, running_lam, lam_max, epochs, 
    ...
    return total_evals, total_grad_calls, hyper_params, intercepts, weights, grid_pass_error
...
def naive_grid_search_2d(lam_min_2d, lam_max_2d, num_grid_2d, epochs, loss_fn, trainDataLoader,
    ...
    for fix_lam in lambdas:
        ...
        total_evals, total_grad_calls, hyper_params, intercepts, weights, grid_pass_error = naive_grid_search(fix_lam, lam_min_2d[1], lam_max_2d[1], num_grid_2d[1], 
        ...
        total_evals_2d += total_evals
        total_grad_calls_2d += total_grad_calls
    ...
    return total_evals_2d, total_grad_calls_2d, hyper_params_2d, intercepts_2d, weights_2d, grid_pass_error_2d